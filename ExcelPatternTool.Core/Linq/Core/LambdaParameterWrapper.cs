...
using ExcelPatternTool.Core.Linq.Core.Interfaces;

namespace ExcelPatternTool.Core.Linq.Core
{
    ...
    internal sealed class LambdaParameterWrapper : IComparable, ILambdaValue
    {
        ...
        public LambdaParameterWrapper InvokeDelegate(object obj, object[] args)
        {
            ...
            for (int i = 0; i < resolvedArgs.Length; i++)
            {
                ...
                if (!Core.InvokeMethod.IsInstanceOfType(delegParams[i].ParameterType, argObj))
